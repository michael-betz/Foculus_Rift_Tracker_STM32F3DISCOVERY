...
//  I2C_InitStructure.I2C_Timing = 0x00902025;	//ToDo: Should be set to 400 kHz fast mode, check that!
  I2C_InitStructure.I2C_Timing = 0x0010020A;	//According to I2C timing excel tool
